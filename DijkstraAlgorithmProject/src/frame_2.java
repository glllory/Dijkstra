...
public class frame_2 extends JFrame implements ActionListener{
	...
	public frame_2()
	{
		...
		nameLabel = new JLabel("Enter the node name or press \"ESC\" when you are done:");
		...
		arcLabel = new JLabel("Enter the Arc between two nodes in the form (ArcName,nodeSource,nodeDestination,ArcWeight) or press \"Done\" when you are done:");
		...
		actionButton2 = new JButton("Enter Arc");
	...
	public void actionPerformed(ActionEvent e) {
		...
		else if(actionCommand.equals("Enter Arc"))
		{
